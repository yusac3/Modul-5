...
class EmployeeController extends Controller
{
    ...
    public function index()
    {
        ...
        $pageTitle = 'Employee List';
        // RAW SQL QUERY
        // $employees = DB::select('select *, employees.id as employee_id, positions.name
        // as position_name from employees left join positions on employees.position_id = positions.id
        // ');
        //BUILD QUERY
